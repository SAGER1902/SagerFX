package tgfx.client.render.entities.projectiles;
...
import tgfx.client.render.TGRenderHelper;
import tgfx.client.render.TGRenderHelper.RenderType;
...
public class DeathEffectEntityRenderer {
	...
	private static final ResourceLocation RES_BIO_EFFECT = new ResourceLocation(TechgunsFX.MODID,"textures/fx/bio.png");
	private static final ResourceLocation RES_LASER_EFFECT = new ResourceLocation(TechgunsFX.MODID,"textures/fx/laserdeath.png");
