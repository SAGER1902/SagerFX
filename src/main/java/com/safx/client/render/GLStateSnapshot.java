...
public class GLStateSnapshot {
	...
	private class LightMapState {
		...
		public LightMapState() {
			lightmapX = GlStateManager.lastBrightnessX;
			lightmapY = GlStateManager.lastBrightnessY;	
		}
		
		public void restore() {
			if(GlStateManager.lastBrightnessX!= lightmapX || GlStateManager.lastBrightnessY!= lightmapY) {
				GlStateManager._glMultiTexCoord2f(GL13.GL_TEXTURE1, lightmapX, lightmapY);
			}
		}
	}
